...
namespace programacion2
{
    ...
    class ConexionNoSabo
    {
        ...
        public void InsertCompra(Compra cp)
        {
            try
            {
                comando.CommandText = "INSERT INTO Compra(taza, tipo_moneda, cantidad) VALUES('" + cp.Taza.ToString() + "','" + cp.Tipo_moneda + "','" + cp.Cantidad.ToString() + "')";
                comando.CommandType = CommandType.Text;
                conectar.Open();
                comando.ExecuteNonQuery();
        ...
        public void InsertVenta(Venta v)
        {
            try
            {
                comando.CommandText = "INSERT INTO Venta(taza, tipo_moneda, cantidad) VALUES('" + v.Taza.ToString() + "','" + v.Tipo_moneda + "','" + v.Cantidad.ToString() + "')";
                comando.CommandType = CommandType.Text;
                conectar.Open();
                comando.ExecuteNonQuery();
