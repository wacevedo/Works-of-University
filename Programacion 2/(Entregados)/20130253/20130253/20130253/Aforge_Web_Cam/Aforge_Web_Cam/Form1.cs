...
namespace Aforge_Web_Cam
{
    public partial class VideoForm : Form
    {
        ...
        {            
            ...
            detenerGrabaciónToolStripMenuItem.Enabled = false; 
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (captureDevice.ShowDialog(this) == DialogResult.OK)
            {
                ...
                detenerGrabaciónToolStripMenuItem.Enabled = true;
        ...
        private void timer1_Tick(object sender, EventArgs e) //Timer 1
        {
            ...
            /*Hacer Validacion que cuando la hora de inicio sea menor a la hora actual,              
            if (Convert.ToInt32(textBox1.Text) < Convert.ToInt32(textBox2.Text)) 
            {
                MessageBox.Show("La hora inicial debe ser mayor o igual a la hora actual");
            }
             */
            //Incio Grabacion
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            textBox3.Text = string.Format("{0:d/MM/yyyy}", DateTime.Now); 
        }
