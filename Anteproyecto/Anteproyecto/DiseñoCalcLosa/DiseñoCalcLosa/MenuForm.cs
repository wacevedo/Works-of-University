...
namespace DiseñoCalcLosa
{
    public partial class MenuForm : Form  //AlphaForms
    {
        ...
        {
            InitializeComponent();
            //cambiando configuracion para el videoreproductor del menu
            axWindowsMediaPlayer1.uiMode = "none";
            axWindowsMediaPlayer1.stretchToFit = true;  
        }

        //importando dll para arrastrar el form desde el recuadro de arriba
        [DllImport("user32.DLL", EntryPoint = "ReleaseCapture")]
        public extern static void ReleaseCapture();
        [DllImport("user32.DLL", EntryPoint = "SendMessage")]
        public extern static void SendMessage(System.IntPtr hWnd, int wMsg, int wParam, int lParam);

        //metodo que permite arrastrar el form 
        ...
        {
            //ocultando algunos botones sin utilizar
            ...
            //ocultando el cuadro que contiene los proyectos recientes y algunos botones
