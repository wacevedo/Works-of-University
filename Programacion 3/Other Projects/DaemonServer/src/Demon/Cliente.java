...
public class Cliente extends Thread {
 ...
 private void GetFechaHora(String minutos, String hora, String dia,
String mes, String anio, String ampm)
 {
  String fechaHora;
  fechaHora = mes +" "+ dia + ", " + anio + ", " + hora+ ", "+ minutos+ ", " + ampm;
  this.fechaHora = fechaHora;
 }
    public Cliente(String minutos, String hora, String dia, String
mes, String anio, String ampm, int index){
     GetFechaHora(minutos, hora, dia, mes, anio, ampm);
     GetIndex(index);
     //metodo constructor que llena la clase desde que se instancia enel form con los parametros
    }

 public DefaultTableModel iniciar() throws ClassNotFoundException
//cambiar DefaultTableModel por lo que se necesite para ejecutar elPDF
    {
...
Logger.getLogger(Cliente.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private DefaultTableModel llamarServidor(String[] arreglo2) throws
ClassNotFoundException  //cambiar DefaultTableModel por lo que se necesite para ejecutar el PDF
      {
