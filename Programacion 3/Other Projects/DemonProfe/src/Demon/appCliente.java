...
public class appCliente {
	...
	/*
	 *  0:0PM no se puede
	 *  Validar lo de 29 feb, a�os biciestos y demas
	  */
	//LOCALE
	...
	private void initialize() {
		...
		frmCliente.setBounds(100, 100, 603, 614);
		frmCliente.getContentPane().setLayout(null);
		
		table = new JTable();
		table.setBounds(10, 551, 562, -178);
		...
		btnSolicitarReporte.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {									
				...
				//MetodoPdf = a./*iniciar();	
				//table= a.iniciar();
				//lblNewLabel.setText(a.iniciar().toString);
			}
		...
		JLabel lblNewLabel_1 = new JLabel("No recivido");
		lblNewLabel_1.setBounds(388, 33, 86, 28);
